...
$(document).ready(function () {
  ...
  $(document).on('click', '.delete-btn', function (event) {
    var userId = $(this).data('id');
    deleteItem(route('users.destroy', userId), '#users_table', 'User');
  });
  ...
  $(document).on('click', '.archive-btn', function () {
    var userId = $(this).data('id');
    archiveItem(route('archive-user', userId), '#users_table', 'User');
  });
  ...
  $(document).on('click', '.restore-btn', function (event) {
    var userId = $(this).data('id');
    restoreItem(route('user.restore-user'), '#users_table', 'User', userId);
  });
