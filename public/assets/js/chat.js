...
$(document).ready(function () {
  ...
  $(document).on('click', function () {
    ...
    $('.chat__people-wrapper-bar').addClass('fa-bars').removeClass('fa-times'); // $('.chat__people-wrapper').
  ...
  window.getOldOrNewConversation = function (reqData, isBefore, isAfter) {
    var isGroup = $('.chat__person-box--active').data('is_group');
    $('.loading-message').removeClass('d-none'); // let urlDetail = userURL + selectedContactId + '/conversation';
  ...
  window.imageRenderer = function (message) {
    return "<a href=\"".concat(message, "\" data-ybox-group=\"group2\" class=\"yBox\"> <img src=\"").concat(message, "\"></a>"); // return `<a href="${message}" data-fancybox="gallery" data-toggle="lightbox" data-gallery="example-gallery" data-src="${message}"><img src="${message}"></a>`
  };
  ...
  window.imageRendererInSideMedia = function (message, id) {
    return "<a href=\"".concat(message, "\" data-ybox-group=\"group2\" class=\"yBox\" id=\"mediaProfile-").concat(id, "\"><img src=\"").concat(message, "\"></a>"); // return `<a href="${message}" data-fancybox="gallery" data-bs-toggle="media" data-gallery="media-gallery" data-src="${message}" id="mediaProfile-${id}"><img src="${message}"></a>`
  };
    ...
    $.ajax({
      ...
      success: function success(result) {
        ...
        if (data) {
          ...
          e.stopPropagation(); // console.log('ok');
        } else {
          // console.log('sip');
