    ...
    <div class="col-sm-12">
        ...
        <div class="row">
            ...
            <div class="form-group col-sm-6 login-group__sub-title">
                ...
                {!! Form::select('role_id', $roles, (isset($user->role_id)) ? $user->role_id : [],  ['class' => 'form-select form-control login-group__input','placeholder' => 'Select Role', 'id' => 'role_id', 'required']) !!}
            </div>
        </div>
        <div class="row">
            <div class="form-group col-sm-6 login-group__sub-title">
